...
> Mega optimize images for web (webp/avif)

[![PyPI version](https://badge.fury.io/py/mega-img-optimize.svg)](https://pypi.org/project/mega-img-optimize/)
...
```bash
pip install mega-img-optimize
```

## Quick Start

```python
from mega_img_optimize import optimize

# Basic usage
result = optimize("your input here")
print(result)
```
...
from mega_img_optimize import batch
